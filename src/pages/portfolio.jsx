...
Here is some stuff I have worked on in the past.
      ...
      <ul style={portStyle.format}> 
          ...
          <img src="./assets/dailyDripImg.PNG" alt="Image of the front page of the daily drip website"  width="200" height="150"/>
        <div  style={light.place}>
      ...
      <ul style={portStyle.format}>
          <h2>Company</h2>
          <img src="./assets/companyImg.PNG" alt="Image of company program in action"  width="254" height="291"/>
        <div style={light.place}>
      ...
      <ul style={portStyle.format}>
          ...
          <img src="./assets/prgImg.PNG" alt="Image of the front page of generator in action"  width="217" height="159"/>
       <div style={light.place}>
      ...
      <ul style={portStyle.format}>
          <h2>Vehicles</h2>
          <img src="./assets/carsImg.PNG" alt="Image of the front page of Vehicles app in action"  width="217" height="159"/>
        <div style={light.place}>
