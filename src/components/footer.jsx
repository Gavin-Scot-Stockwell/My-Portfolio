...
export default function Footer() {
    return(
        ...
        <p style={Even.format}>
        <Icons src={'src/assets/icons8-github-30.png'} alt={'github logo'} x={'0px'} y={'-10px'}/>
        <Badges title={'GitHub'} backColor={'caracole'} link={'https://github.com/Gavin-Scot-Stockwell'}/>
        </p>
        
        <p style={Even.format}>
        <Icons src={'src/assets/icons8-linkedin-48.png'} alt={'Linkedin logo'} x={'0px'} y={'-10px'}/>
        <Badges title={'Linkedin'} backColor={'#0288d1'} link={'https://www.linkedin.com/in/gavin-stockwell-803b50345/'}/>
        </p>
        
        <p style={Even.format}>
        <Icons src={'src/assets/icons8-stack-overflow-48.png'} alt={'Stack Overflow logo'} x={'0px'} y={'-10px'}/>
